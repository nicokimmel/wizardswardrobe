...
SS.LOCATIONS = {
	LOKKESTIIZ = {
		...
		x2 = 118000,
		y1 = 55500,
		y2 = 57000,-- the coord change due auto-equip issue on it
		z1 = 100700,
		z2 = 108600,-- the coord change due auto-equip issue on it
	},
	YOLNAHKRIIN = {
		x1 = 93500,
		x2 = 101500,
		y1 = 49000,
		y2 = 52000, -- the coord change due auto-equip issue on it
