local language = {
	...
	WW_MSG_IMPORTGEARENOENT = "Es konnten nicht alle Gegenstände importiert werden. Sorge dafür, dass du alle Items im Inventar hast. Der Trait spielt keine Rolle.",
	WW_MSG_CONDITIONSAVED = "Bedingung für das Setup gespeichert.",
	...
	WW_MENU_LEGACYSELECTION = "Alte Zonenauswahl",
	WW_MENU_LEGACYSELECTION_TT = "Bringt die alte Zonenliste zurück.",
	...
	WW_MENU_EXTRASLOTS = "Zusätzliche Setup Slots",
	WW_MENU_EXTRASLOTS_TT = "Fügt unten zusätzliche Slots für Setups ein. Diese können mit einer eigenen Bedingung versehen werden um sie automatisch auszurüsten.",
	...
	WW_BUTTON_EDIT = "Umbenennen",
	WW_BUTTON_TOGGLEAUTOEQUIP = "Automatisches Laden\nein-/ausschalten",
	WW_BUTTON_ADD = "Seite hinzufügen",
	WW_BUTTON_DELETE = "Seite löschen",
	...
	WW_RENAME_SETUP = "Neuer Name für das Setup:",
	...
	WW_DELETE = "Löschen",
	WW_CONDITIONS = "Bedingungen",
	WW_CONDITION = "Bedingung",
	WW_CONDITION_TT = "Genauer Bossname wie er auch ingame angezeigt wird.",
	WW_TRIGGER = "Auslöser",
	...
	WW_BANKING_TT = "|cFFFFFF[Klick]|r um Ausrüstung zu entnehmen,\n|cFFFFFF[Shift + Klick]|r zum Einlagern",
