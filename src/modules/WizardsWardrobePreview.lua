...
function WWP.CreatePreviewWindow()
	...
	for gearIndex, gearSlot in ipairs(WW.GEARSLOTS) do
		...
		gearLabel:SetDimensionConstraints(AUTO_SIZE, AUTO_SIZE, 269, 42)
	...
	skillBox:SetAnchor(TOPLEFT, preview, TOPLEFT, 350, 50)
	...
	foodBox:SetAnchor(TOPLEFT, preview, TOPLEFT, 350, 50 + 102 + 10)
	...
	cpBox:SetAnchor(TOPLEFT, preview, TOPLEFT, 350, 50 + 102 + 10 + 60 + 10)
	...
	iconBox:SetAnchor(TOPLEFT, preview, TOPLEFT, 350, 50 + 102 + 10 + 60 + 10 + 346 + 10 + 2)
